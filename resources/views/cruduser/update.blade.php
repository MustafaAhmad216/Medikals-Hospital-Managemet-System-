                            ...
                            <div class="card">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Enter User Data</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="basic-form">
                                            <form>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input input type="email" name="email" id="email" class="form-control" value="{{$users->email }}">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input style="width:70px; display:inline-block; color:white;" class="form-control" placeholder="+20" readonly>
                                                        <input style="width:600px; display:inline-block; margin-left: 4px;" input type="phone" name="phone" id="phone" class="form-control" value="{{$users->phone }}">
                                                    </div>
                                                </div>
                                                <div class="input-group mb-3">
